...
Pixel& Pixel::operator=(const Pixel& other)
{
	if (this != &other)
	{
		//Pixel* p1 = new Pixel(other.r,other.g,other.b,other.a);
	//	this->r = *(new Component(other.r));
	//	this->g = *(new Component(other.g));
	//	this->b = *(new Component(other.b));
//		this->a = *(new Component(other.a));
		//this->r = p1->r;
		//this->g = p1->g;
		//this->b = p1->b;
		//this->a = p1->a;
	//	p1 = NULL;
	//	Set(ComponentScale(other.r, 1), ComponentScale(other.g, 1), ComponentScale(other.b, 1), ComponentScale(other.a, 1));
		Set(Component(other.r), Component(other.g), Component(other.b), Component(other.a));
		//Set('c', 'v', 'c', 'k');
	}
	return *this;
}
